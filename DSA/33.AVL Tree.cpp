...
AVL tree data structure AVL tree is a self - balancing Binary Search Tree(BST) where the difference between
heights of left and right subtrees cannot be more than one(1) for all nodes. This difference is called the Balance Factor.
...
avl tree - types of rotations

Since AVL tree is nothing but a Balanced Binary Search Tree, the Time complexity of the operations is always more efficient as compared to regular BST.
